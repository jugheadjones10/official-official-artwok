...
public class FirestorePagingAdapterImpl extends FirestorePagingAdapter<MainPost, PostViewHolder> {
    ...
    public FirestorePagingAdapterImpl(FirestorePagingOptions<MainPost> options, User user, Context mContext, NavController navController, SwipeRefreshLayout swipeRefreshLayout){
        super(options);
        this.user = user;
