package com.example.artwokmabel.profile.request;
...
import com.example.artwokmabel.profile.Activites.ImagePickerActivity;
...
//                        firebaseFirestore.collection("Users").document(LoginActivity.uid).collection("Listings").document((numPostArray[0] + 1) + " " + dateToStr).set(objectMap)
//                        firebaseFirestore.collection("Users").document(LoginActivity.uid).collection("Listings").document(dateToStr).set(objectMap)
//                                .addOnSuccessListener(aVoid -> {
//                                    Toast.makeText(AddListingActivity.this, "Successfully uploaded ic_dm.", Toast.LENGTH_LONG).show();
//                                    finish();
//                                    uploadProgress.setVisibility(View.INVISIBLE);
