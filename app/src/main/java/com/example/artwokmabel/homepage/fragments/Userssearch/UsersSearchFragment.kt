package com.example.artwokmabel.homepage.fragments.Userssearch
...
import com.algolia.instantsearch.guides.gettingstarted.ViewModel
...
class UsersSearchFragment constructor(val searchView: SearchView) : Fragment() {

        private val connection = ConnectionHandler()

        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
            val view: View =  inflater.inflate(R.layout.fragment_search_users, container, false)
