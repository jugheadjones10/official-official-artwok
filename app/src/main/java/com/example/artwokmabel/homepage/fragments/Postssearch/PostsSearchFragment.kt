package com.example.artwokmabel.homepage.fragments.Postssearch
...
import com.algolia.instantsearch.guides.gettingstarted.SearchPostViewModel
...
class PostsSearchFragment constructor(val searchView: SearchView) : Fragment(){

    private val connection = ConnectionHandler()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view: View =  inflater.inflate(R.layout.fragment_search_posts, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewModel = ViewModelProviders.of(requireActivity())[SearchPostViewModel::class.java]
