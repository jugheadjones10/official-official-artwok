...
import com.example.artwokmabel.homepage.fragments.Listingssearch.MyFacetListViewHolder
...
class ViewModel : ViewModel() {
    ...
    val index = client.initIndex(IndexName("Users"))
    val searcher = SearcherSingleIndex(index)

    val dataSourceFactory = SearcherSingleIndexDataSource.Factory(searcher) { hit ->
        Product(
            hit.json.getPrimitive("username").content,
